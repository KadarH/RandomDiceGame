...
<div class="w3-card-4 hall1 w3-display-left w3-center"  >
		<div class="w3-container w3-light-blue hall3 ">
			
			<button class="w3-btn-floating-large.w3-disabled w3-black w3-hover-light-blue w3-margin w3-padding-12" >My Score:<%out.print(a+" pt");%></button>
			<button class="w3-btn-floating-large.w3-disabled w3-black w3-hover-light-blue w3-margin w3-padding-12" >My best Score :<%out.print(b+" pt");%></button>
			<form action="<%=request.getServletContext().getContextPath()%>/zone/play" method="post" class="w3-container " >
	
			
			 <input class="w3-circle w3-green w3-xlarge w3-hover-border-pale-yellow  w3-margin w3-padding-12"  type="submit" name="action" value="<%out.print(st); %>" />
		
			</form>
		
			  
			
			<button class="w3-btn-floating-large.w3-disabled w3-black w3-hover-light-blue w3-margin w3-padding-12" >My Chance:<%out.print(c);%></button>
			<button class="w3-btn-floating-large.w3-disabled w3-black w3-hover-light-blue w3-margin w3-padding-12" ><% out.print(nbrLancee+"/20"); %></button>
